...
const ProgressNavbar = () => {
  ...
  return (
    <nav className="fixed right-6 top-1/2 -translate-y-1/2 z-40 hidden lg:flex flex-col items-center gap-4">
      ...
      <a href="#hero" className="opacity-75 hover:opacity-100 transition-opacity duration-500 flex items-center justify-center w-full mb-3">
        <img src={synapsioLogo} alt="Synapsio" className="h-auto w-20" />
      </a>
